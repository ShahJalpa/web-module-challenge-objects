...
function createMenuItem(name, price, category/*Your code here*/){
    /*Your code here*/
...
console.log(createMenuItem('egg & cheeze biscuit', 5, 'breakfast'));
...
*/
  reviews.push({name:"Jalpa", rating:3.5, feedback:"drink is so so."});
  console.log(reviews);
...
function getReviewByIndex(array, index/*Your code here*/) {
  /*Your code here*/
...
function getLastReview(array/*Your code here*/) {
  /*Your code here*/
